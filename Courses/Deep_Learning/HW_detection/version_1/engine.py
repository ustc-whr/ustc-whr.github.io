...
def evaluate(model, test_loader, device):
        ...
        for batch, (images, targets_true) in enumerate(test_loader):
            ...
            if count==1:
                ...
                for img in images:
                    ...
                    print(img_)
                    break
                save_sample(img_.cpu(),target_,"/root/img/img1.png")

            
            #save_sample(images_,targets_pred,'./img/')
    ...
    print(f'auc(recall, precision):{auc(recall, precision)}')
